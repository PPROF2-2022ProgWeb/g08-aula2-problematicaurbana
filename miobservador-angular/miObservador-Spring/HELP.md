...
* The following dependencies are not known to work with Spring Native: 'Spring Boot DevTools, Rest Repositories, Spring REST Docs'. As a result, your application may not work as expected.
* The original package name 'Grupo8.miObservador-Spring' is invalid and this project uses 'Grupo8.miObservadorSpring' instead.
...
```
$ docker run --rm -p 8080:8080 miObservador-Spring:0.0.1-SNAPSHOT
```
